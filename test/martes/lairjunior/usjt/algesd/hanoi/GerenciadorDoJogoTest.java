...
class GerenciadorDoJogoTest {
    ...
    void letsPlay() {
        ...
        try {
            ...
            Disk disk1 = matchTest.getPino(GerenciadorDoJogo.PINO_1).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_3).add(disk1);
            matchTest.incrementarMovimentos();

            // Second move - move disk 2 from pin 1 to pin 2
            Disk disk2 = matchTest.getPino(GerenciadorDoJogo.PINO_1).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_2).add(disk2);
            matchTest.incrementarMovimentos();

            // Third move - move disk 1 from pin 3 to pin 2
            disk1 = matchTest.getPino(GerenciadorDoJogo.PINO_3).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_2).add(disk1);
            matchTest.incrementarMovimentos();

            // Fourth move - move disk 3 from pin 1 to pin 3
            Disk disk3 = matchTest.getPino(GerenciadorDoJogo.PINO_1).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_3).add(disk3);
            matchTest.incrementarMovimentos();

            // Fifth move - move disk 1 from pin 2 to pin 1
            disk1 = matchTest.getPino(GerenciadorDoJogo.PINO_2).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_1).add(disk1);
            matchTest.incrementarMovimentos();

            // Sixth move - move disk 2 from pin 2 to pin 3
            disk2 = matchTest.getPino(GerenciadorDoJogo.PINO_2).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_3).add(disk2);
            matchTest.incrementarMovimentos();

            // Seventh move - move disk 1 fromm pin 1 to pin 3
            disk1 = matchTest.getPino(GerenciadorDoJogo.PINO_1).removeDisk();
            matchTest.getPino(GerenciadorDoJogo.PINO_3).add(disk1);
            matchTest.incrementarMovimentos();
